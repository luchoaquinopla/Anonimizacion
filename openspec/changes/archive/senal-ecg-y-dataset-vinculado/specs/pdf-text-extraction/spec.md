# Delta para Extracción de Texto de PDF
...
tratarse como texto.
(Previously: el escenario asumía que el trazado del ECG era una imagen rasterizada que se
ignoraba; en realidad es vectorial y se extrae como señal en una capability separada.)
